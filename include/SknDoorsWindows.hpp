...
struct SknGarageDoor : Service::GarageDoorOpener {     // A Garage Door Opener
  ...
  SknGarageDoor() : Service::GarageDoorOpener(){       // constructor() method
...
struct SknWindowShade : Service::WindowCovering {     // A motorized Window Shade with Hold Feature
  ...
  SknWindowShade() : Service::WindowCovering(){       // constructor() method
